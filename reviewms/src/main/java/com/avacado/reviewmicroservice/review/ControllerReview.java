...
public class ControllerReview {
	...
	public ResponseEntity<Review> getReview(@PathVariable Long reviewId){
		return new ResponseEntity<>(serviceReview.getReview(reviewId), HttpStatus.OK);
	}
	
	@PutMapping("/{reviewId}")
	public ResponseEntity<String> updateReview(@PathVariable Long reviewId, @RequestBody Review review){
		boolean isReviewUpdated = serviceReview.updateReview(reviewId, review);
		if(isReviewUpdated) {
	...
	public ResponseEntity<String> deleteReview(@PathVariable Long reviewId){
		boolean isReviewDeleted = serviceReview.deleteReview(reviewId);
		if(isReviewDeleted) {
